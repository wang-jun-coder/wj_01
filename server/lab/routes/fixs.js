 ...
 *
 * */
function fixs_001(req, res, next) {

    var r = { root: path.resolve(__dirname+'/../public/fixs') };
    res.sendFile('fixs_001.html', r);
}
router.get('/fixs_001', fixs_001);
router.post('/fixs_001', fixs_001);
