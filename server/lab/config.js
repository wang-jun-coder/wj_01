...
CONFIG.SERVER_DOMAIN_ENUM.DEBUG_LOCAL   = "127.0.0.1";
...
// 设置服务器端口号
CONFIG.SERVER_PORT_ENUM = {};
CONFIG.SERVER_PORT_ENUM.RELEASE         = "";
CONFIG.SERVER_PORT_ENUM.DEBUG_LOCAL     = "3001";
CONFIG.SERVER_PORT_ENUM.DEBUG_DEV       = "";
CONFIG.SERVER_PORT = CONFIG.SERVER_PORT_ENUM.RELEASE;
if(CONFIG.SERVER_STATE == CONFIG.SERVER_STATE_ENUM.DEBUG_DEV)
    CONFIG.SERVER_PORT = CONFIG.SERVER_PORT_ENUM.DEBUG_DEV;
if(CONFIG.SERVER_STATE == CONFIG.SERVER_STATE_ENUM.DEBUG_LOCAL)
    CONFIG.SERVER_PORT = CONFIG.SERVER_PORT_ENUM.DEBUG_LOCAL;

// 设置服务器域名链接
CONFIG.SERVER_FULL_URL = "https://" + CONFIG.SERVER_DOMAIN;
if(CONFIG.SERVER_STATE == CONFIG.SERVER_STATE_ENUM.DEBUG_DEV)
    CONFIG.SERVER_FULL_URL = "http://" + CONFIG.SERVER_DOMAIN;
if(CONFIG.SERVER_STATE == CONFIG.SERVER_STATE_ENUM.DEBUG_LOCAL)
    CONFIG.SERVER_FULL_URL = "http://" + CONFIG.SERVER_DOMAIN + ":" + CONFIG.SERVER_PORT;
